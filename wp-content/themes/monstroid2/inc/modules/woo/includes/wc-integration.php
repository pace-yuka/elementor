...
if ( ! function_exists( 'monstroid2_wc_wrapper_before' ) ) {
	...
	function monstroid2_wc_wrapper_before() {
		?>
			<div <?php monstroid2_get_single_product_container_classes() ?>>
			<div class="row">
 ...
 */
if ( ! function_exists( 'monstroid2_get_single_product_container_classes' ) ) {
		function monstroid2_get_single_product_container_classes( $classes = null, $fullwidth = false ) {
			if ( $classes ) {
				$classes .= ' ';
			}
			$classes .= 'site-content__wrap ';
			if ( ! apply_filters( 'monstroid2-theme/site/fullwidth', $fullwidth ) ) {
				$layout_type = monstroid2_theme()->customizer->get_value( 'single_product_container_type' );
