...
add_action( 'jet-theme-core/register-config', 'monstroid2_disable_magic_button' );


/**
 * Disable magic button for elementor
 *
 * @since  1.1.11
 */

function monstroid2_disable_magic_button( $config_manager ) {
